...
public class AbstractReportBean {
    ...
    protected void createConn() {
        try {
            ...
            conn = DriverManager.getConnection("oracle.jdbc.OracleDriver://jdbc:oracle:thin:@localhost:1521:XE", "Castiel", "Castiel2008");
            //conn = DriverManager.getConnection("jdbc:jtds:sqlserver://localhost:1433/swp_roche", "sa", "radical");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
